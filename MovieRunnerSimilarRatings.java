 ...
 *                 that's why my output of sudan algorithm is different from the DUKE algorithm.
...
public class MovieRunnerSimilarRatings {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("----------Weighted average algorithm optimized by sudan DECEMBER 14 2019------------");
        System.out.println("DUKE:   \"sum of (similar rating(i) *rating of the movie(i))/count of the raters\"");
        System.out.println("sudan: \"sum of (similar rating(i) *rating of the movie(i))/ sum of the similar rating(i)\", will achieve better results.");
